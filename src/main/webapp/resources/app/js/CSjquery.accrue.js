...
;(function( $, window, document, undefined ){
    ...
    var calculateAmortization = function( elem, options, output_elem ){
        ...
        if ( loan_info!==0 ) {
            ...
            console.log(EMIObject.status[0]);
            ...
            var output_content = '<table id="res_table" class="accrue-amortization table table-bordered table-hover table-striped">'+
                    '<tr>'+
            ...
            for ( var i=0; i<loan_info.num_payments; i++) { 
                ...
                output_content = output_content+ 
                    ...
                    '<'+cell_tag+' >'+EMIObject.status[i]+'</'+cell_tag+'>'+
                    '<'+cell_tag+' >'+'<button class="pay btn btn-primary">Pay </button>'+'</'+cell_tag+'>'+
                    '</tr>';
                }
                else{
                	output_content = output_content+ 
                    '<tr>'+
                    '<'+cell_tag+' class="accrue-payment-number">'+(i+1)+'</'+cell_tag+'>'+
                    '<'+cell_tag+' class="accrue-payment-amount">Rs'+loan_info.payment_amount_formatted+'</'+cell_tag+'>'+
                    '<'+cell_tag+' class="accrue-total-interest">Rs'+counter_interest.toFixed(2)+'</'+cell_tag+'>'+
                    '<'+cell_tag+' class="accrue-total-payments">Rs'+counter_payment.toFixed(2)+'</'+cell_tag+'>'+
                    '<'+cell_tag+' class="accrue-balance">Rs'+counter_balance.toFixed(2)+'</'+cell_tag+'>'+
                    '<'+cell_tag+' >'+EMIObject.status[i]+'</'+cell_tag+'>'+
                    '<'+cell_tag+' >'+'<button type="button" class="pay btn btn-primary">Pay </button>'+'</'+cell_tag+'>'+
                    '</tr>';
                }
            }
