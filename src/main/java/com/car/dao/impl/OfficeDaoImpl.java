...
public class OfficeDaoImpl implements OfficeDao {
	...
	private static final String FETCH_ALL = "SELECT * FROM OFFICE";
	...
	private static final String GET_ID="select id from office where name=?";
	...
	@Override
	public List<OfficeDto> get() throws IOException {
		try {
	...
	@Override
	public int getId(String office) throws IOException
	{
		try
		{
			return template.queryForObject(GET_ID,(rs,rownum)->{
				return rs.getInt("id");
			},office);
		}catch (DataAccessException e) {
			throw new IOException(e);
